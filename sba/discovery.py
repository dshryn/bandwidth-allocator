...
def arp_parse_windows():
    ...
    # parse lines like-  192.168.1.5    00-11-22-33-44-55   dynamic
    devices = []
...
def scan(cidr=None):
    # call system arp and quick pings to update cache, then parse arp table
    osname = platform.system().lower()
    # ping sweep across a cidr
    if osname.startswith("windows"):
        devices = arp_parse_windows()
    else:
        devices = arp_parse_linux()
